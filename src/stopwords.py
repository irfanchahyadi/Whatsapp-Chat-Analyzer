...
STOPWORDS = {
    ...
    'in': {
        ...
        'a','abis','ad','ada','adalah','adanya','adapun','agak','agaknya','agar','ah','aj','aja','akan','akankah','akhir',
        ...
        'betul','betulkah','bgt','biar','biasa','biasanya','bila','bilakah','bisa','bisakah','blm','boleh','bolehkah',
        'bolehlah','br','bu','buat','bukan','bukankah','bukanlah','bukannya','bulan','bung','c','cara',
        'caranya','cukup','cukupkah','cukuplah','cuma','d','dah','dahulu','dalam','dan','dapat','dapet','dari',
        ...
        'diungkapkan','doang','dong','donk','dpt','dr','dua','dulu','e','eh','elu','emang','empat','emg','enak','engga',
		'enggak','enggaknya','entah','entahlah','entar','f','g','ga','gak','gih','gimana','gini','gitu','gmn','gua','gue','guna',
		'gunakan','gw','h','hadap','hah','haha','hahaha','hahahaha','hai','hal','halo','hallo','hampir','hanya','hanyalah',
        'hari','harus','haruslah','harusnya','hehe','helo','hello','hendak','hendaklah','hendaknya','hingga',
        'i','ia','ialah','ibarat','ibaratkan','ibaratnya','ibu','ikut','ingat','ingat-ingat','ingin',
        'inginkah','inginkan','ini','inikah','inilah','itu','itukah','itulah','iy','iya','j','jadi','jadilah',
        'jadinya','jangan','jangankan','janganlah','jauh','jawab','jawaban','jawabnya','jd','jg','jelas',
        'jelaskan','jelaslah','jelasnya','jika','jikalau','juga','jumlah','jumlahnya','justru',
        'k','kadar','kala','kalau','kalaulah','kalaupun','kali','kalian','kalo','kami','kamilah','kamu',
        ...
        'kira-kira','kiranya','kita','kitalah','kl','klo','km','kok','kurang','kyk','l','lagi','lagian','lah','lain',
        'lainnya','laku','lalu','lama','lamanya','langsung','lanjut','lanjutnya','lebih','lewat','lg',
        'lihat','lima','lu','luar','lo','m','macam','mah','maka','makanya','makin','maksud','malah','malahan',
        ...
        'mungkinkah','n','nah','naik','namun','nanti','nantinya','ngak','nggak','ni','nih','ntar','nya','nyaris','nyata','nyatanya',
        'o','oh','ok','oke','oleh','olehnya','orang','p','pa','pada','padahal','padanya','pak','paling','panjang','pantas',
        'para','pas','pasti','pastilah','penting','pentingnya','per','percuma','perlu','perlukah','perlunya',
        ...
        'tidakkah','tidaklah','tiga','toh','tp','trus','ttp','tuh','tuju','tunjuk','turut','tutur','tuturnya','u','ucap','ucapnya','ud','udah','udh',
        'ujar','ujarnya','umumnya','ungkap','ungkapnya','untuk','usah','usai','utk','v','w','waduh','wah','wahai',
        'waktunya','walau','walaupun','wk','wkwk','wkwkwk','wkwkwkwk','wong','x','y','ya','yaa','yah','yaitu','yak','yakin','yakni','yang','yg','z'}
}